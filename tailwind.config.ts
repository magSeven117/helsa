  ...
  theme: {
  	...
  	extend: {
  		colors: {
  			...
  			'color-complementary-danger': 'var(--color-complementary-danger)',
  			'color-complementary-success': 'var(--color-complementary-success)',
  			'color-complementary-warning': 'var(--color-complementary-warning)',
  			sidebar: {
