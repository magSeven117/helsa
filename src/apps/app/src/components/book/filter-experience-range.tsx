...
import { Slider } from '@helsa/ui/components/slider';
...
const ExperienceRange = ({ onSelect }: Props) => {
    ...
    <div className="flex h-[150px] w-full items-center justify-around px-3 flex-col gap-3 " aria-hidden="true">
      ...
      >
        {sliderValue === 0 ? (
          ...
          <div className="flex justify-center items-center gap-2">{sliderValue} Years</div>
        )}
      </Button>
    </div>
  );
