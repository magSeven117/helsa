      ...
      <section className="py-20 ">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold  mb-4">Beneficios Exclusivos para Profesionales</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold  mb-1">Cursos Especializados</h4>
                    <p className="text-muted-foreground">
                      Acceso a más de 500 cursos médicos actualizados mensualmente.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Sesiones interactivas con expertos internacionales cada semana.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Obtén certificaciones reconocidas internacionalmente.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="bg-muted rounded-2xl p-8">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold  mb-4">Centro de Conocimiento</h3>
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-muted-foreground">Acceso Continuo</div>
                  </div>
                  <div className="text-center">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className=" rounded-2xl p-8">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold  mb-6">Tecnología de Vanguardia</h3>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
                    <span className="text-muted-foreground">Análisis Predictivo</span>
                    <div className="w-16 h-2 bg-gray-200 rounded-full">
                  ...
                  <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
                    <span className="text-muted-foreground">Seguridad de Datos</span>
                    <div className="w-16 h-2 bg-gray-200 rounded-full">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold  mb-2">IA para Diagnóstico</h4>
                    <p className="text-muted-foreground">
