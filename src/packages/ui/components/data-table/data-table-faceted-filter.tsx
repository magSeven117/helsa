              ...
              <div className="hidden space-x-1 lg:flex">
                {selectedValues.size > 2 ? (
                  ...
                  options
                    ...
                    .map((option) => (
                      <Badge variant="secondary" key={option.value} className="rounded-none px-1 font-normal">
                        {option.label}
                      </Badge>
                    ))
                )}
                ...
                return (
                  ...
                  >
                    ...
                    {facets?.get(option.value) && (
                      <span className="ml-auto rounded-none flex h-4 w-4 items-center justify-center font-mono text-xs">
                        {facets.get(option.value)}
                      </span>
                    )}
                  </CommandItem>
